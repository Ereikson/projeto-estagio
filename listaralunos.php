...
if (isset($_POST['id'])) {
    ...
    if (mysqli_connect_errno()) {
        ...
        if (mysqli_query($con, $sql)) {
            ...
            header("Location: listaralunos.php?message=Aluno%20deletado%20com%20sucesso!");
        } else {
            echo "Erro ao deletar o aluno: " . mysqli_error($con);
        }
        mysqli_close($con);
    }
}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="listaralunos.php" method="post">
                                            ...
                                            <button type="submit" name="botdelalu" value="ok">Del</button>
                                        </form>
                                    </td>
                                    <td>
                                        <form action="php/formaltalunos.php" method="post">
                                            <input type="hidden" name="id" value="<?php echo $row["id"]; ?>" />
                                            <button type="submit" name="botaltalun" value="ok">Alt</button>
                                        </form>
                                    </td>
                                </tr>
                            <?php } ?>
